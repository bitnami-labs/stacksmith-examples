...
4. Upload the _simple-asp-net-core-2-todo-app.zip_ file (which can be found in [releases](../../../releases) for the project.
...
```
$ cd app/bin/Release/netcoreapp2.0/publish && zip -r -9 ../simple-asp-net-core-2-todo-app.zip zip .
```
